...
4. **train_optimize_save_models**: Trains machine learning models concurrently with different parameters and feature representation techniques, optimizes them, and saves the trained models along with a summary CSV file necessary for the Flask server.
